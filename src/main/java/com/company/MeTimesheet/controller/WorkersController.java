...
@CrossOrigin(origins = "https://halliburton.vercel.app/", allowCredentials = "true", allowedHeaders = {"Authorization", "Content-Type"})
public class WorkersController {
    ...
    //Get:  Brings all data
    @CrossOrigin(origins = "https://halliburton.vercel.app/")
