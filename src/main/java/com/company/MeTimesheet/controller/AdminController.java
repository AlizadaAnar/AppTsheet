...
@CrossOrigin(origins = "https://management-app-62t5.vercel.app", allowCredentials = "true", allowedHeaders = {"Authorization", "Content-Type"})
public class AdminController {
    ...
    //Get: Get an Admin
    @CrossOrigin(origins = "https://management-app-62t5.vercel.app")
